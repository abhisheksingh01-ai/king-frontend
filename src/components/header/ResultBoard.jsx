...
// Make sure to import your API correctly
...
export default function ResultBoard() {
  ...
  const updateResults = async () => {
    try {
      ...
      const allGames = GAMES.map((game) => {
        ...
        if (!gameData || !gameData.result) return null;
  ...
  return (
    <div className="min-h-screen w-full bg-neutral-950 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {/* 1. Ambient Background Glow (Spotlight Effect) */}
      ...
      <div className="w-full flex justify-center py-12 px-4 relative z-10">
        ...
        <div className="relative w-full max-w-md rounded-3xl p-0.5 bg-linear-to-b from-yellow-300 via-amber-600 to-black shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
          ...
          <div className="w-full h-full rounded-[22px] bg-[#0f0f0f] relative overflow-hidden">
            ...
            <div className="relative px-6 py-10 text-center">
              ...
              <div className="flex items-center justify-center gap-3 mb-8">
                ...
                <h2 className="text-transparent bg-clip-text bg-linear-to-r from-yellow-200 via-yellow-400 to-yellow-600 font-extrabold text-lg tracking-[0.25em] uppercase drop-shadow-sm">
                  Live Results
                </h2>
              </div>

              {/* Results List */}
              <div className="space-y-8 min-h-50 flex flex-col justify-center">
                {loading ? (
                  ...
                  results.map((item, index) => (
                    ...
                    >
                      ...
                      {index === 0 && (
                        <div className="absolute -inset-4 bg-linear-to-r from-transparent via-red-900/20 to-transparent blur-xl transition-all duration-1000"></div>
                      )}
